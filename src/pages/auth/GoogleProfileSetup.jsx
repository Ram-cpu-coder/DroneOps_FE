...
const selfSelectableRoles = userRoles.filter((role) => role.id !== "system_administrator");

const GoogleProfileSetup = ({ pendingGoogleProfile, error, isLoading, onComplete, onAuthViewChange }) => {
  ...
  return (
    <form className="auth-form" onSubmit={handleSubmit}>
      <div>
        ...
        <p>Confirm your DroneOps organization and role before we create your workspace access.</p>
      </div>
      ...
      <fieldset className="auth-form-grid google-profile-grid" disabled={isLoading}>
